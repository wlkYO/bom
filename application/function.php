...
function codeRule($ruleName = '成品', $doorType='M9'){
    if($ruleName == '成品') {
        if ($doorType == 'M7') {
            ...
            $arr = array("3"=>array("order_column_name"=>'DANG_CI',"code_name"=>'档次'),
                ...
                "31"=>array("order_column_name"=>'TESHUYQ,MENSHANCZ',"code_name"=>'门类'),
                "32"=>array("order_column_name"=>'FIXED',"code_name"=>'无意义')
            );
        }elseif ($doorType == 'M4'){
            $arr = array(
    ...
    if($ruleName == '半品门扇') {
        $arr = array("3"=>array("order_column_name"=>'DANG_CI',"code_name"=>'档次'),
            ...
            "24"=>array("order_column_name"=>'MS_FIXED',"code_name"=>'无意义')
        );
    }
    if($ruleName == '半品门框') {
        $arr = array("3"=>array("order_column_name"=>'DANG_CI',"code_name"=>'档次'),
...
{
    $arr = array('M8'=>'防火门','M9'=>'钢质门','M6'=>'装甲门','M7'=>'木质门','W9'=>'套装门','M4'=>'耐火窗');
    return $arr[$doorType];
}
